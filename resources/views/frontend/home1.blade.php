        ...
        <div class="row justify-content-center">
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 mb-4">
                <div class="register_donate_item">
                    ...
                    <a href="{{route('blogdetails')}}" class="d-block black_bg text-center">Read More</a>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 mb-4">
                <div class="register_donate_item">
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                <div class="counter_item text-center">
                    <img src="{{ asset('frontend/images/icon/c1.png') }}" alt="">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                <div class="counter_item text-center">
                    <img src="{{ asset('frontend/images/icon/c2.png') }}" alt="">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12 mb-5">
                <div class="counter_item text-center">
                    <img src="{{ asset('frontend/images/icon/c3.png') }}" alt="">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="counter_item text-center">
                    <img src="{{ asset('frontend/images/icon/c4.png') }}" alt="">
        ...
        <div class="row align-items-center g-0 service_wrap">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6  col-12 mb-5 order_2">
                <div class="service_content ps-5">
                    ...
                    <a href="{{route('servicedetails')}}" class="red_btn service_btn">Read More</a>
                </div>
            </div>
                    ...
                    <div class="row g-0">
                        <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5 col-12 col-5">
                            <div class="campaign_img">
                                ...
                                <a href="{{route('campaigndetails')}}">Read More</a>
                            </div>
                        </div>
                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-7 col-12">
                            <div class="campaign_content">
                                ...
                                <p>Lorem ipsum dolor sit consectetur adipiscing elit, sed do incididunt et dolore magna
                                    aliqua.</p>
        ...
        <div class="row ">
            ...
            <div class="testi_slider slider-spacing">
                <div class="testi_slider_item">
                    ...
                    <div class="testi_owner d-flex gap-4 align-items-center">
                        <div class="testi_img img">
                            <a href="#"><img src="{{ asset('frontend/images/ts1.png') }}" alt=""></a>
                        </div>
                ...
                <div class="testi_slider_item">
                    ...
                    <div class="testi_owner d-flex gap-4 align-items-center">
                        <div class="testi_img img">
                            <a href="#"><img src="{{ asset('frontend/images/ts2.png') }}" alt=""></a>
                        </div>
                        <div class="testi_name">
                            <h5>Niro Markusa</h5>
                            <p>Designer</p>
                ...
                <div class="testi_slider_item">
                    ...
                    <div class="testi_owner d-flex gap-4 align-items-center">
                        <div class="testi_img img">
                            <a href="#"><img src="{{ asset('frontend/images/ts3.png') }}" alt=""></a>
                        </div>
                        <div class="testi_name">
                            <h5>Nicolas Mark</h5>
                            <p>Designer</p>
