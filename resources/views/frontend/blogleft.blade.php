        ...
        <div class="col-xl-8">
          <div class="km_blog__main">
            ...
            <div class="km_blog_imgbx mb-30">
              <div class="row g-4">
                <div class="col-xl-6">
                  <img src="{{ asset('frontend/images/blog/sl-1.jpg') }}" alt="images not found" class="w-100">
                </div>
                <div class="col-xl-6">
                  <img src="{{ asset('frontend/images/blog/sl-2.jpg') }}" alt="images not found" class="w-100">
                </div>
              </div>
            </div>
            ...
            <div class="km__blockquote__box mt-60">
              <div class="d-flex wrap gap-20">
                <div class="ls__imgbx">
                  <img src="{{ asset('frontend/images/blog-details/client.jpg') }}" alt="images not founds" class="w-100">
                </div>
                <div class="content">
                ...
                <ul>
                  <li class="d-flex align-items-center gap-20">
                    <div class="ls_r_imgbx">
                      <img src="{{ asset('frontend/images/blog-details/comment-1.png') }}" alt="images not founds" class="img-fluid">
                    </div>
                  ...
                  <li class="d-flex align-items-center gap-20 ms-sm-4">
                    <div class="ls_r_imgbx">
                      <img src="{{ asset('frontend/images/blog-details/comment-2.png') }}" alt="images not founds" class="img-fluid">
                    </div>
                    <div class="comments__text">
                      <span><b class="me-3">Robart Sony</b>Says Jul 21, 2021 at 10:00am</span>
                      <p class="mt-3">
