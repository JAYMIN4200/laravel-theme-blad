          ...
          <div class="km_blog__main">
            <div class="blog__one">
              <div class="blog__img img">
                <a href="{{route('blogdetails')}}"><img src="{{ asset('frontend/images/blog/b-bg.jpg') }}" alt="images not founds"
                    class="img-fluid"></a>
              </div>
            ...
            <div class="km__blog__two mt-4 mt-xxl-5 mt-xl-5 mt-lg-5 position-relative">
              ...
              <p class="mb-4">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia
            ...
            <div class="km_blog_three mt-4 mt-xl-5 mt-lg-5">
              <div class="km_blog__slider">
                <div class="slide__item img">
                  <a href="{{route('blogdetails')}}"><img src="{{ asset('frontend/images/blog/bl-2.jpg') }}" alt="images not fonds"
                      class="img-fluid"></a>
                </div>
                <div class="slide__item img">
                  <a href="{{route('blogdetails')}}"><img src="{{ asset('frontend/images/blog/bl-2.jpg') }}" alt="images not fonds"
            ...
            <div class="km_blog_four mt-4 mt-xxl-5 mt-xl-5 mb-lg-5 mb-5">
              <div class="km__video__box position-relative">
                <img src="{{ asset('frontend/images/blog/video-bg.jpg') }}" alt="images not founds" class="img-fluid">
        ...
        <div class="col-xl-4">
          <div class="km__blog__sidebar">
            ...
            <div class="bl__sidebar__widget elemontor__widget">
              <div class="bl__card">
                <div class="card__header mb-30">
                  <img src="{{ asset('frontend/images/blog/bl-1.png') }}" alt="images not founds" class="img-fluid">
                </div>
            ...
            <div class="bl-sidebar-widget bl-quick-link-widget mt-4 mt-xl-5 mt-lg-5">
              ...
              <ul class="bl-ct-list">
                <li><a href="{{route('photogallery')}}"><span class="me-2"><i class="fa-solid fa-arrow-right"></i></span> Portfolio</a></li>
                <li><a href="{{route('blogdetails')}}"><span class="me-2"><i class="fa-solid fa-arrow-right"></i></span> Our Blog</a></li>
                <li><a href="{{route('aboutus')}}"><span class="me-2"><i class="fa-solid fa-arrow-right"></i></span> About</a></li>
                <li><a href="{{route('teammember')}}"><span class="me-2"><i class="fa-solid fa-arrow-right"></i></span> Our Team</a></li>
                <li><a href="{{route('contacts')}}"><span class="me-2"><i class="fa-solid fa-arrow-right"></i></span> Contact</a></li>
              </ul>
            </div>
