        ...
        <div class="row justify-content-center">
                ...
                <div class="km__blog position-relative">
                    <div class="feature-image img mb-30">
                        <a href="{{route('campaigndetails')}}">
                            <img class="w-100" src="{{ asset('frontend/images/cm1.jpg') }}" alt="images not found" />
                        </a>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-12 mb-4">
                <div class="km__blog position-relative">
                    <div class="feature-image img mb-30">
                        <a href="{{route('campaigndetails')}}">
                            <img class="w-100" src="{{ asset('frontend/images/cm2.jpg') }}" alt="images not found" />
                        </a>
                        <span class="data-tags d-flex justify-content-center align-items-center">
                            <b>13</b>
                            feb
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-12 mb-4">
                <div class="km__blog position-relative">
                    <div class="feature-image img mb-30">
                        <a href="{{route('campaigndetails')}}">
                            <img class="w-100" src="{{ asset('frontend/images/cm3.jpg') }}" alt="images not found" />
                        </a>
                        <span class="data-tags d-flex justify-content-center align-items-center">
                            <b>13</b>
                            feb
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-12 mb-4">
                <div class="km__blog position-relative">
                    <div class="feature-image img mb-30">
                        <a href="{{route('campaigndetails')}}">
                            <img class="w-100" src="{{ asset('frontend/images/cm4.jpg') }}" alt="images not found" />
                        </a>
                        <span class="data-tags d-flex justify-content-center align-items-center">
                            <b>13</b>
                            feb
