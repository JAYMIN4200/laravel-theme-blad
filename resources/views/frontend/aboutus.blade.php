        ...
        <div class="row align-items-center g-0 g-xxl-5 g-xl-5 g-lg-5">
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                <div class="km__who__content">
                    ...
                    <a href="{{route('aboutus')}}" class="primary__btn">Explore Now</a>
                </div>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                <div class="km__who__imgbx img">
                    <img src="{{ asset('frontend/images/about/doctor.jpg') }}" alt="images not found"
                        class="img-fluid" />
                </div>
            </div>
        </div>
        ...
        <div class="row g-4 justify-content-center">
                ...
                <div class="km__blog position-relative">
                    <div class="feature-image  img mb-30">
                        <a href="{{route('campaigndetails')}}">
                            <img class="w-100" src="{{ asset('frontend/images/about/blog.jpg') }}"
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="km__blog">
                    <div class="feature-image img mb-30">
                        <a href="{{route('campaigndetails')}}">
                            <img class="w-100" src="{{ asset('frontend/images/about/blog-2.jpg') }}"
                                alt="images not found">
                        </a>
                    </div>
                    <div class="km__post__content">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="km__blog">
                    <div class="feature-image img mb-30">
                        <a href="{{route('campaigndetails')}}">
                            <img class="w-100" src="{{ asset('frontend/images/about/blog-3.jpg') }}"
                                alt="images not found">
                        </a>
                    </div>
                    <div class="km__post__content">
