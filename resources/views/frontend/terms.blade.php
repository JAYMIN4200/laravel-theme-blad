...
<section class="km__terms__conditions__Section ptb-120">
    <div class="container">
        <div class="imgbx">
            <img src="{{ asset('frontend/images/terms/hurt.jpg') }}" alt="images not founds" class="img-fluid">
        </div>
        <div class="km_reasons mt-30">
            <h2 class="fs-42 mb-30">Reasons for Using Website Terms and Conditions</h2>
            <p class="mb-30">
                There are many variations of passages of Lorem Ipsum available, but the majority have suffered
                alteration in
                some form, by injected humour, or randomised words which don't look even slightly believable. If you are
                going
                to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in middle
                of
                text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary,
                making
                this the first true generator on the Internet.
            </p>
            <p class="m-0">It uses a dictionary of over 200 Latin words, combined with a handful of model sentence
        ...
        <div class="km_agreement mt-30">
            ...
            <p class="mb-30">looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and
        ...
        <div class="mt-30 km_essential">
            ...
            <p class="mb-30">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece
                of
        ...
        <div class="mt-30 km_understanding">
            ...
            <p class="mb-30">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece
                ...
                professor at
                Hampden-Sydney College in Virginia, </p>
            <p class="m-0">looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and
                going
        ...
        <div class="mt-30 km_dealing">
            ...
            <p class="mb-30">But I must explain to you how all this mistaken idea of denouncing pleasure and praising
                pain
            ...
            <p class="m-0">
                ...
                but
                because occasionally circumstances occur in which toil and pain can procure him some great anpleasure.
                To take
                a trivial example, which of us ever undertakes laborious physical exercise, except to obtain some
                advantage
                from But who has any right to find fault with
            </p>
        </div>
        <div class="mt-30">
            ...
            <p class="m-0">Nor again is there anyone who loves or pursues or desires to obtain pain of itself, because
                it is
        ...
        <div class="km_fr-images mt-30">
            <div class="row g-4 text-center">
                <div class="col-md-6">
                    <img src="{{ asset('frontend/images/terms/t1.jpg') }}" alt="images not founds" class="img-fluid">
                </div>
                <div class="col-md-6">
                    <img src="{{ asset('frontend/images/terms/t2.jpg') }}" alt="images not founds" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
