        ...
        <div class="row justify-content-center">
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 mb-5 mb-xl-0 mb-lg-0">
                <div class="register_donate_item2">
                    ...
                    <p>Nor again is there anyone who loves or pursues or desires to obtain pain of itself, because pain,
                        but
                        because
                        occasionally</p>
                </div>
        ...
        <div class="row g-4 justify-content-center">
                ...
                <div class="km__service position-relative">
                    <div class="feature-image  img mb-30">
                        <a href="{{route('campaigndetails')}}">
                            <img class="w-100" src="{{ asset('frontend/images/about/service.jpg') }}"
                    ...
                    <div class="km__post__content">
                        ...
                        <p class="mb-30">Lorem ipsum dolor sit consectetur adipiscing elit, sed do incididunt et dolore
                            magna
                            aliqua.</p>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="km__service">
                    <div class="feature-image img mb-30">
                        <a href="{{route('campaigndetails')}}">
                            <img class="w-100" src="{{ asset('frontend/images/about/service-2.jpg') }}"
                                alt="images not found">
                        </a>
                    </div>
                    <div class="km__post__content">
                        ...
                        <p class="mb-0">Lorem ipsum dolor sit consectetur adipiscing elit, sed do incididunt et dolore
                            magna
                            aliqua.</p>
                    </div>
                </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                <div class="km__service">
                    <div class="feature-image img mb-30">
                        <a href="{{route('campaigndetails')}}">
                            <img class="w-100" src="{{ asset('frontend/images/about/service-3.jpg') }}"
                                alt="images not found">
                        </a>
                    </div>
                    <div class="km__post__content">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-6 col-lg-6 col-md-7 col-sm-8 col-10">
                            <div class="km__testimonial__content">
                                ...
                                <p class="text-white mb-30"> These cases are perfectly simple and easy to distinguish.
                                    In a free hour,
        ...
        <div class="row justify-content-center">
            <div class="col-xl-7 col-lg-7 col-md-9 col-sm-11 col-12">
                <div class="common_title1 text-center">
                    ...
                    <span>When our power of choice is untrammelled and when nothing prevents our being able to do what
                        we like
                        best, every
        ...
        <div class="row justify-content-center">
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 mb-4">
                <div class="gallary_item">
                    ...
                    <a href="{{ asset('frontend/images/h2_g1.jpg') }}" data-fancybox="gallery"><i
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 mb-4">
                <div class="gallary_item">
                    ...
                    <a href="{{ asset('frontend/images/h2_g2.jpg') }}" data-fancybox="gallery"><i
                            class="fa-solid fa-plus"></i></a>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 mb-4">
                <div class="gallary_item">
                    ...
                    <a href="{{ asset('frontend/images/h2_g3.jpg') }}" data-fancybox="gallery"><i
                            class="fa-solid fa-plus"></i></a>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 mb-4">
                <div class="gallary_item">
                    ...
                    <a href="{{ asset('frontend/images/g1.jpg') }}" data-fancybox="gallery"><i
                            class="fa-solid fa-plus"></i></a>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12 mb-4 mb-xl-0 mb-lg-0 mb-md-0">
                <div class="gallary_item">
                    ...
                    <a href="{{ asset('frontend/images/g2.jpg') }}" data-fancybox="gallery"><i
                            class="fa-solid fa-plus"></i></a>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                <div class="gallary_item">
                    ...
                    <a href="{{ asset('frontend/images/g3.jpg') }}" data-fancybox="gallery"><i
                            class="fa-solid fa-plus"></i></a>
                </div>
            </div>
        </div>
